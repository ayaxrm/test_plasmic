...
import Avatar from "../../Avatar"; // plasmic-import: XTKC1JhUGNbq/component
...
import sty from "./PlasmicTestimonial.module.css"; // plasmic-import: 7XMgK7C9Y5MY/css
import QuoteDashesIcon from "./icons/PlasmicIcon__QuoteDashes"; // plasmic-import: un9nUXOvrXPO/icon
  ...
  return (
    ...
    >
      ...
      <Stack__
        as={"div"}
        hasGap={true}
        className={classNames(projectcss.all, sty.freeBox__bOqZs)}
      >
        <div
          className={classNames(
            projectcss.all,
        ...
        <Stack__
          as={"div"}
          hasGap={true}
          className={classNames(projectcss.all, sty.freeBox__evgLo)}
        >
          <div
            className={classNames(
              projectcss.all,
