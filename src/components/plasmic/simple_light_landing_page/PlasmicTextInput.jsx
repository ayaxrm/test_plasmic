...
import sty from "./PlasmicTextInput.module.css"; // plasmic-import: JEH9x61VAO_Y/css
import SearchsvgIcon from "./icons/PlasmicIcon__Searchsvg"; // plasmic-import: eQ7qeLiqlc0I/icon
import ChecksvgIcon from "./icons/PlasmicIcon__Checksvg"; // plasmic-import: 5qEcVtBMjZTC/icon
    ...
    >
      ...
      >
        {renderPlasmicSlot({
          defaultContents: (
            <SearchsvgIcon
              className={classNames(projectcss.all, sty.svg__czS1A)}
              role={"img"}
            />
          ),
      ...
      >
        {renderPlasmicSlot({
          defaultContents: (
            <ChecksvgIcon
              className={classNames(projectcss.all, sty.svg__aOnMp)}
              role={"img"}
            />
          ),
