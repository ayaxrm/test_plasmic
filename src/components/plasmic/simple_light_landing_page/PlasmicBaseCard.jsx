...
import sty from "./PlasmicBaseCard.module.css"; // plasmic-import: YGACddWYvtn2/css
...
function PlasmicBaseCard__RenderFunc(props) {
  ...
  return (
    ...
    >
      <div
        className={classNames(projectcss.all, sty.freeBox__amSv, {
          [sty.freeBoxlong__amSvDrOi2]: hasVariant($state, "long", "long")
        })}
      >
        {renderPlasmicSlot({
          defaultContents:
      ...
      <div
        className={classNames(projectcss.all, sty.freeBox__e79Bd, {
          [sty.freeBoxlong__e79BdDrOi2]: hasVariant($state, "long", "long")
        })}
      >
        {renderPlasmicSlot({
          defaultContents: (
            <svg
              className={classNames(projectcss.all, sty.svg__xCd72)}
              role={"img"}
            />
          ),
