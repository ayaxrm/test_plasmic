...
import sty from "./PlasmicFaq.module.css"; // plasmic-import: nf3TAlgKpsVP/css
  ...
  return (
    ...
    >
      <Stack__
        as={"div"}
        hasGap={true}
        className={classNames(projectcss.all, sty.freeBox__k1NcA)}
      >
        <div className={classNames(projectcss.all, sty.freeBox__jmpaH)}>
          <div className={classNames(projectcss.all, sty.freeBox__r8M5F)}>
            {renderPlasmicSlot({
